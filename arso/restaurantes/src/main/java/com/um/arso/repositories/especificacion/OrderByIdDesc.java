...
public class OrderByIdDesc implements Specification<Restaurante> {
    ...
    public Comparator<Restaurante> getComparator() {
        return (Restaurante r1,Restaurante r2) -> r2.getId().compareTo(r1.getId());
    }

    @Override
    public Bson toComparator() {
        return Sorts.descending("_id");
    }
