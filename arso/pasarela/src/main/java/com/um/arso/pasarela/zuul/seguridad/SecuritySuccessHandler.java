...
public class SecuritySuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (datosUsuario != null) {
			...
			redirectStrategy.sendRedirect(request, response, "http://localhost:8090/restaurantes");
			
		} else {
			//TODO Registrarse y volver hacer login y cambiar archivo para adaptarlo
			// Hay que pasarle nombre usuario para el OUthid
